<x-layout>
    <x-slot:title>Temukan Organisasi Impianmu</x-slot:title>
                ...
                @foreach ($results as $result)
                    <div
                        ...
                        <div class="p-5">
                            <a href="#" class="">
                                <h5
                                    class="mb-2 min-h-16 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                                    {{ $result['nama_organisasi'] }}
                                </h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                                {{ Str::limit($result['deskripsi'], 200) }}</p>
                            <a href="/organisasi/{{ $result['id'] }}"
