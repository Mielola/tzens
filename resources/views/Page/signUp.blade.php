...
<body class="h-[100vh] w-screen">
    <section class="bg-gray-50 dark:bg-gray-900 h-full w-full">
        <div
            class="flex h-full flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 sm:justify-center">
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="#">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="#"
                                class="text-sm font-medium text-blue-400 hover:underline dark:text-primary-500">Forgot
                                password?</a>
                        </div>
                        <button type="submit"
